imap <C-i> <Esc>
imap <Tab> <C-x><C-o>
imap iname <c-r>="mtk54039 chuan.li@mediatek.com"<cr>
imap isign <c-r>=""<cr>
imap itime <c-r>=strftime("20%y-%m-%d %H:%M:%S")<cr>
let NERDTreeIgnore=[ '\.pyc$','\Thumbs.db']
...
autocmd FileType python highlight OverLength ctermbg=darkred ctermfg=white guibg=#000000"FFD9D9
autocmd FileType python match OverLength /\%126v.\+/
